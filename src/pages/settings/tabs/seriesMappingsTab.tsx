      ...
      <VStack align="stretch" spacing={6}>
        ...
        {stats && (
          <SimpleGrid columns={{ base: 2, md: 4 }} spacing={4}>
            <Stat>
              <StatLabel>Total Mappings</StatLabel>
              <StatNumber>{stats.total}</StatNumber>
            </Stat>
            <Stat>
              <StatLabel>User Confirmed</StatLabel>
              <StatNumber>{stats.userConfirmed}</StatNumber>
            </Stat>
            <Stat>
              <StatLabel>Auto Generated</StatLabel>
              <StatNumber>{stats.autoGenerated}</StatNumber>
            </Stat>
            <Stat>
              <StatLabel>Expiring Soon</StatLabel>
              <StatNumber color={stats.expiringSoon > 0 ? "orange.500" : undefined}>{stats.expiringSoon}</StatNumber>
            </Stat>
          </SimpleGrid>
        )}
        ...
        <Flex gap={4} wrap="wrap" align="center">
          ...
          <InputGroup maxW="300px">
            ...
            <Input placeholder="Search by series title..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} size="sm" />
          </InputGroup>
          ...
          <HStack spacing={2} ml="auto">
            <Button size="sm" leftIcon={<RepeatIcon />} onClick={loadMappings} isLoading={isLoading}>
              Refresh
            </Button>
            <Button size="sm" leftIcon={<DownloadIcon />} onClick={handleExportMappings}>
              Export
            </Button>
                ...
                <HStack spacing={4} align="start">
                  ...
                  {mapping.cover_image && (
                    <Image
                      ...
                      objectFit="cover"
                      borderRadius="md"
                      fallback={<Box width="60px" height="80px" bg="gray.200" borderRadius="md" />}
                    />
                  )}
