      ...
      if (cachedList) {
        ...
        getAnimeList({
          ...
          onCompleted: async (data) => {
            ...
            setLoadedStatuses((prev) => ({ ...prev, [MediaListStatus.Current]: true }));
            await db.setAniListCache(listKey, data, ANILIST_CACHE_TTL);
            setProfileLoading(false);
          },
        });
      }
    ...
    <>
      <VStack spacing={4} align="stretch" mb={4}>
        ...
        <Text color="text.secondary" fontSize="sm">
          Manage your AniList profile and anime lists.
        </Text>
      </VStack>
        ...
        <VStack spacing={6} align="stretch">
          ...
          <Drawer isOpen={isOpen} onClose={onClose} size="md">
            ...
            <DrawerContent bg="bg.primary" color="text.primary">
              <DrawerHeader color="accent.primary">Cache Controls</DrawerHeader>
              <DrawerCloseButton />
              <DrawerBody>
                <VStack align="stretch" spacing={6}>
                  <Box>
                    ...
                    <VStack align="stretch" spacing={3}>
                      ...
                      <Button size="sm" onClick={handleForceRefresh} isLoading={profileLoading}>
                    ...
                    <VStack align="stretch" spacing={3}>
                      {displayStatuses.map((status) => (
                        <HStack key={status}>
                          ...
                          <Button size="xs" onClick={() => handleForceRefreshList(status)}>
                            Force refresh
                          </Button>
                        </HStack>
                      ))}
                    ...
                    <Flex gap={4} align="center">
                      ...
                      <Box>
                        ...
                        <Flex gap={2} alignItems="center">
                          ...
                          <Link
                            href={selectedEntry.media.siteUrl}
                            isExternal
                            color="accent.primary"
                            fontSize="sm"
                            _hover={{ opacity: 0.8 }}
