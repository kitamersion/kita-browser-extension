...
// INTEGRATION_EVENTS (MYANIMELIST)
export const INTEGRATION_MYANIMELIST_AUTH_CONNECT = "INTEGRATION_MYANIMELIST_AUTH_CONNECT "; // background service worker
export const INTEGRATION_MYANIMELIST_AUTH_DISCONNECT = "INTEGRATION_MYANIMELIST_AUTH_DISCONNECT";
export const INTEGRATION_MYANIMELIST_AUTH_POLL = "INTEGRATION_MYANIMELIST_AUTH_POLL";
export const INTEGRATION_MYANIMELIST_AUTH_START = "INTEGRATION_MYANIMELIST_AUTH_START";

// CACHED MEDIA
export const CACHED_MEDIA_METADATA_ADD_OR_UPDATE = "CACHED_MEDIA_METADATA_ADD_OR_UPDATE";
export const CACHED_MEDIA_METADATA_DELETE = "CACHED_MEDIA_METADATA_DELETE";
