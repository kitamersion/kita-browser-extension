...
export const TAG_REFRESH = "TAG_REFRESH";
...
export const VIDEO_TAG_RELATIONSHIP_REFRESH = "VIDEO_TAG_RELATIONSHIP_REFRESH";

// AUTO_TAG_EVENTS
export const AUTO_TAG_ADD_OR_UPDATE = "AUTO_TAG_ADD_OR_UPDATE";
export const AUTO_TAG_DELETE_BY_ID = "AUTO_TAG_DELETE_BY_ID";
export const AUTO_TAG_REFRESH = "AUTO_TAG_REFRESH";
...
export const OPEN_ANILIST_PENDING_REVIEW = "OPEN_ANILIST_PENDING_REVIEW"; // content script -> background service worker

// SYNC_EVENTS
export const SYNC_EMAIL_CONFIRMED = "SYNC_EMAIL_CONFIRMED"; // content script -> background service worker
